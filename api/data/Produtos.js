const produtos = [
    {
      ...
      },
      {
        ...
        description:
          "O estilo lendário das quadras de tênis ficou ainda melhor com o Stan Smith Bold. Uma plataforma grossa no solado deixa o clássico mais alto. O modelo feminino também tem cabedal clean em camurça macia combinando com um patch de couro no calcanhar. As Três Listras perfuradas completam o look icônico.",
        preço: 499.99,
        
      },
      {
        
        nome: "TÊNIS SUPERSTAR (UNISSEX)",
        imagem:
        ...
        description:
          "Da quadra de basquete à sala de aula. Todo mundo merece um par do adidas Superstar. Este tênis infantil celebra os 50 anos do clássico design com biqueira de concha. Das inconfundíveis Três Listras serrilhadas ao confortável cupsole de borracha, esta edição de aniversário chega para homenagear um ícone. Não importa se a escolha for um look todo branco, todo preto ou outra cor qualquer, pois as crianças estarão sempre confortáveis.",
        preço: 459.99,
      ...
      },
      {
        ...
        description:
          "Este gorro mantém você confortável com tecido de malha macia. Sua barra canelada dobrável compartilha suas credenciais esportivas na forma de um logo adidas das Três Barras bordado.",
        preço: 149.99,
      ...
      },
      {
        ...
        nome: "MOCHILA ADIDAS Hy3000 TURQUESA",
        imagem:
        ...
        description:
          "Conforto ou estilo? Você pode ter os dois com esta mochila adidas. Ela é espaçosa o suficiente para caber tudo de que você precisa, mas pequena o bastante para um look casual. Dois bolsos mantêm seus itens essenciais organizados. O tecido supermacio e os detalhes dourados adicionam um toque de glamour ao seu dia.",
        preço: 499.99,
      ...
      },
      {
        ...
        description:
          "Quando o sol está forte, você precisa se vestir adequadamente. Complete o seu conjunto de treino em clima quente com este boné Superlite da adidas. A construção confortável de seis painéis possui painéis laterais perfurados para ajudar a mantê-lo fresco. Uma viseira anti-reflexo torna a corrida em concreto brilhante agradável aos olhos.",
        preço: 199.99,
        
      },
      {
        
        nome: "CAMISA 2 ALEMANHA 24 INFANTIL",
        imagem:
          "https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/326ba20ac0674417a3ab366f031fa27c_9366/Camisa_2_Alemanha_24_Infantil_Rosa_IP8161_01_laydown.jpg",
        description:
          "A torcida tradicional do futebol destacada de uma maneira totalmente nova. Finalizada em roxo e azul vibrantes, o design inspirado nas penas da águia ganha destaque no peito dessa camisa infantil adidas da Alemanha. O tecido AEROREADY que controla a umidade e o escudo do time em tecido premium se combinam para tornar essa camisa perfeita para um suporte confortável.",
        preço: 298.00,
        
      },
      {
        
        nome: "BOLA UCL PRO ISTANBUL",
        imagem:
          "https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/18b3d33ee8e6497587bfaf620125b38d_9366/Bola_UCL_Pro_Istanbul_Branco_HU1576_01_standard.jpg",
        description:
          "Finalmente. As estrelas estarão alinhadas em Istambul em 2023. Criada para as etapas finais da UEFA Champions League, esta bola adidas exibe uma estampa atraente que celebra a localização única da cidade e comemora seu vínculo inesquecível com a maior competição de futebol do mundo. Por trás da estampa, a superfície sem costuras e a câmara de butil garantem que esta bola com qualidade profissional certificada pela FIFA brilhe em campo.",
        preço: 999.99,
        
      },
      {
        
        nome: "CHUTEIRA FLEXÍVEL CAMPO PREDATOR CLUB",
        imagem:
          "https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/278e196168514974aa4e4a03b8df16d3_9366/Chuteira_Flexivel_Campo_Predator_Club_Amarelo_IG7757_22_model.jpg",
        description:
          "O foco do jogo é o gol, e essa chuteira foi criada para te ajudar a marcar vários. Todo. Tempo. Nova adidas Predator: pura perfeição. Com uma camada de espuma que garante conforto e elementos Strikeprint no meio, o cabedal sintético dessa chuteira realmente se destaca em termos de aparência e sensação. Por baixo, o solado versátil garante que você esteja sempre na posição ideal para mirar e chutar.",
        preço: 379.99,
      ...
      },
      {
        ...
        description:
          "Mantenha-se fiel aos Los Blancos em qualquer aventura da sua vida. Este moletom de futebol adidas declara seu apoio ao Real Madrid com a assinatura no peito e uma estampa extragrande nas costas. O algodão confortável mantém você à vontade, seja para treinar ou relaxar.",
        preço: 398.00,
